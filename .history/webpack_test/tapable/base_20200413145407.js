...
class Test {
  ...
  interceptor () {
    this.hooks.compiler.register(tap => {
      conbsole.log('register', tap)
      return tap
    }) 
    this.hooks.compiler.call(args => {
      conbsole.log('call', ...args)
    }) 
    this.hooks.compiler.call(tap => {
      conbsole.log('tap', tap)
    }) 
  }
  tap () {
